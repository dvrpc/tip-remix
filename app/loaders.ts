export async function getPoints(ids: string) {
  const data = await fetch(
    `https://arcgis.dvrpc.org/portal/rest/services/Transportation/PATIP_FY2025_2028_Point/FeatureServer/0/query`,
    {
      method: "POST",
...
export async function getLines(ids: string) {
  const data = await fetch(
    `https://arcgis.dvrpc.org/portal/rest/services/Transportation/PATIP_FY2025_2028_Line/FeatureServer/0/query`,
    {
      method: "POST",
